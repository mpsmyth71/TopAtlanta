...
namespace TopAtlanta.Common
{
    public static class StringExtension
    {
        ...
        public static string RemoveNonNumeric(this string str)
        {
            ...
            return new Regex("[^0-9]").Replace(str, String.Empty).Trim();
        }
        ...
        /// <summary>
        /// Parses a ten digit string to the correct phone number format
        /// </summary>
        /// <param name="value">string value of ten digits</param>
        ...
        public static string SplitStringLast(this string str)
        {
            if (str.Contains('-'))
            {
                return str.Split(new char[] { '-' })[1];
        ...
        public static string SplitStringFirst(this string str)
        {
            if (str.Contains('-'))
            {
